...
const About = () => {
  ...
  return (
    ...
    <section className="section-padding pt-8 md:pt-10 lg:pt-12" id="about-contact">
      <div className="container mx-auto mt-8 grid gap-8 md:mt-10 lg:grid-cols-2 lg:items-stretch">
        <article className="flex h-full flex-col rounded-3xl border border-border bg-card p-6 md:p-7">
          ...
          <div className="mt-6 grid gap-4 xl:grid-cols-2">
            {maintenanceChecklistSections.map((section) => (
              <div key={section.title} className="rounded-2xl border border-border bg-background p-4">
                ...
                {section.note ? (
                  <p className="mt-4 text-sm font-semibold text-navy">{section.note}</p>
                ) : null}
              </div>
            ))}
          </div>
          ...
          <div className="mt-4 rounded-2xl border border-border bg-background p-4">
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              {monthlyMaintenanceSections.map((section) => (
                <div key={section.title} className="rounded-2xl border border-border/70 bg-card p-4">
