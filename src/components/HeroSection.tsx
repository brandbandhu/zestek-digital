      ...
      <>
        ...
        <div className="absolute inset-0 z-[2] flex items-start">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              <motion.h2 variants={fadeInLeft} className={`mt-4 text-3xl font-extrabold leading-tight md:text-4xl lg:text-5xl ${overlay.titleClassName ?? ""}`}>
                {overlay.title}
              </motion.h2>
        ...
        <div className="absolute inset-0 z-[2] flex items-center">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <motion.h2 variants={fadeInLeft} className="mt-4 text-3xl font-extrabold leading-tight md:text-4xl lg:text-5xl">
                {overlay.title}
              </motion.h2>
    ...
    <>
      ...
      <div className="absolute inset-x-0 top-0 z-[2] px-4 pt-7">
        ...
        >
          ...
          <motion.h2 variants={fadeInLeft} className="mt-3 text-2xl font-extrabold leading-tight">{overlay.title}</motion.h2>
