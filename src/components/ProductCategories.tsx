...
const categories = [
  ...
  {
    icon: Factory,
    tag: "Photocopier & Commercial",
    title: "Printers for Photocopier or Commercial Segment",
    desc: "Choose Epson or Konica Minolta, then narrow by Color or Monochrome and shortlist the right models.",
